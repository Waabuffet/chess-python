@echo off
Rem this code is used to clean the images after photoshop so it wont give any warnings in console
Rem YES i cut the pieces images using photoshop just because i can
